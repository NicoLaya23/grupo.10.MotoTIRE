...
body('model').notEmpty().withMessage('El campo no puede estar vacío.'),
body('price').isNumeric().withMessage('El campo solo admite números.'),
body('measures').notEmpty().withMessage('El campo no puede estar vacío.'),
cpUpload,
